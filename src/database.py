...
class Database:
    ...
    def add_new_event_planning(self, author: str, event_chatroom: str, event_description: str, event_date: date) -> bool:
        """
        Insert new event in event database
        :param author: Name of the person who create the event
        :param event_chatroom
        ...
        new_event = {
            ...
            "event_title": event_chatroom,
            "event_date": event_date.strftime(DATE_FORMAT),
            "event_description": event_description
        }
        try:
            if self.check_presence_event_planning(event_chatroom):
